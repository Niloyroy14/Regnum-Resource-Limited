...
@section('title')
 Manikgonj signning ceremony-Regnum Resource Limited
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row ml-5 mt-5">
            <div class="col-md-11">
                <div class="headers1">
                    <h2 class="mt-3">MANIKGONJ SIGNNING CEREMONY</h2>
                <p> <a href="{{route('index')}}">Home /</a> <a href=""> Project/ </a> <span> Manikgonj signning ceremony</span> </p>
                </div> 
            </div>
        </div>
        <div class="row ml-5 mt-3">
            <div class="col-md-12 signning">
                <img src="{{ asset('images/Gallery/'.'2.jpg')}}" alt="4-Copy-1.jpg">
