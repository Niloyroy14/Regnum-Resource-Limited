...
@section('title')
 Opening ceremony by video conference system from ministry of..-Regnum Resource Limited
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row ml-5 mt-5">
            <div class="col-md-11">
                <div class="headers1">
                    <h2 class="mt-3">opening-ceremony-by-video-conference-system</h2>
                <p> <a href="{{route('index')}}">Home /</a> <a href=""> Project/ </a> <span> opening-ceremony..</span> </p>
                </div> 
            </div>
        </div>
        <div class="row ml-5 mt-3">
            <div class="col-md-12 signning">
                <img src="{{ asset('images/Gallery/'.'4.jpg')}}" alt="4-Copy-1.jpg">
